    ...
    return (
        <div className="filters-container">
            ...
            <ul class="filters-container__content">
                <li class="filters-container__content__list">
                    <button class="filters-container__content__list__button-filter " type="button" href="#">
                        <p>anna field</p>
                        <span class="filters-container__content__list__refinement-count">275</span>
                    </button>
                </li>
                <li class="filters-container__content__list">
                    <button class="filters-container__content__list__button-filter " type="button" href="#">
