...
// ../../node_modules/.pnpm/search-insights@2.2.3/node_modules/search-insights/dist/search-insights-browser.cjs.min.js
var require_search_insights_browser_cjs_min = __commonJS({
  "../../node_modules/.pnpm/search-insights@2.2.3/node_modules/search-insights/dist/search-insights-browser.cjs.min.js"(exports) {
    "use strict";
    ...
    function objectKeysPolyfill() {
      var e, t, n, i;
      Object.keys || (Object.keys = (e = Object.prototype.hasOwnProperty, t = !{ toString: null }.propertyIsEnumerable("toString"), i = (n = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"]).length, function(o) {
    ...
    function makeSendEvents(e) {
      return function(t) {
        ...
        if (!this._userHasOptedOut) {
          ...
          var i = t.map(function(e2) {
            var t2, i2, o = e2.filters, r = __rest(e2, ["filters"]), s = Object.assign(Object.assign({}, r), { userToken: (i2 = null === (t2 = e2) || void 0 === t2 ? void 0 : t2.userToken, null !== i2 && void 0 !== i2 ? i2 : n._userToken) });
    ...
    function sendRequest(e, t, n, i, o, r) {
      return e(o + "/1/events?X-Algolia-Application-Id=" + t + "&X-Algolia-API-Key=" + n + "&X-Algolia-Agent=" + encodeURIComponent(i.join("; ")), { events: r });
    }
    var version = "2.2.3";
    ...
    function addEventType(e, t) {
      return t.map(function(t2) {
        return Object.assign({ eventType: e }, t2);
      });
    }
    ...
    var requestWithSendBeacon = function(e, t) {
      ...
      if (!navigator.sendBeacon(e, n))
        return requestWithXMLHttpRequest(e, t);
    };
    var requestWithXMLHttpRequest = function(e, t) {
    ...
    function processQueue(e) {
      ...
      if (t) {
        var n = getFunctionalInterface(this), i = e[t];
        i.queue = i.queue || [];
        var o = i.queue;
        o.forEach(function(e2) {
          var t2 = [].slice.call(e2), i2 = t2[0], o2 = t2.slice(1);
          n.apply(void 0, [i2].concat(o2));
        }), o.push = function(e2) {
          var t2 = [].slice.call(e2), i2 = t2[0], o2 = t2.slice(1);
          n.apply(void 0, [i2].concat(o2));
        };
    ...
    function createInsightsClient(e) {
      return getFunctionalInterface(new AlgoliaAnalytics({ requestFn: e }));
    }
...
// ../../node_modules/.pnpm/search-insights@2.2.3/node_modules/search-insights/index-browser.cjs.js
var require_index_browser_cjs = __commonJS({
  "../../node_modules/.pnpm/search-insights@2.2.3/node_modules/search-insights/index-browser.cjs.js"(exports, module) {
...
export default require_index_browser_cjs();
//# sourceMappingURL=search-insights.js.map
