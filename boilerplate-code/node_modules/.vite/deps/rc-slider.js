...
function useMergedState(defaultStateValue, option) {
  ...
  var changeEventPrevRef = React4.useRef();
...
var SliderContext = React5.createContext({
  min: 0,
  max: 0,
  direction: "ltr",
  step: 1,
...
var Handle = React6.forwardRef(function(props, ref) {
  ...
  var handleNode = React6.createElement("div", _extends({
    ref,
...
var Handles = React7.forwardRef(function(props, ref) {
  ...
  return React7.createElement(React7.Fragment, null, values.map(function(value, index) {
    return React7.createElement(Handle_default, _extends({
...
function useDrag(containerRef, direction, rawValues, min, max, formatValue, triggerChange, finishChange, offsetValues) {
  var _React$useState = React8.useState(null), _React$useState2 = _slicedToArray(_React$useState, 2), draggingValue = _React$useState2[0], setDraggingValue = _React$useState2[1];
  var _React$useState3 = React8.useState(-1), _React$useState4 = _slicedToArray(_React$useState3, 2), draggingIndex = _React$useState4[0], setDraggingIndex = _React$useState4[1];
  var _React$useState5 = React8.useState(rawValues), _React$useState6 = _slicedToArray(_React$useState5, 2), cacheValues = _React$useState6[0], setCacheValues = _React$useState6[1];
  var _React$useState7 = React8.useState(rawValues), _React$useState8 = _slicedToArray(_React$useState7, 2), originValues = _React$useState8[0], setOriginValues = _React$useState8[1];
  var mouseMoveEventRef = React8.useRef(null);
  var mouseUpEventRef = React8.useRef(null);
  ...
  var updateCacheValueRef = React8.useRef(updateCacheValue);
  ...
  var returnValues = React8.useMemo(function() {
...
function Track(props) {
  ...
  var _React$useContext = React9.useContext(context_default), direction = _React$useContext.direction, min = _React$useContext.min, max = _React$useContext.max, disabled = _React$useContext.disabled, range = _React$useContext.range;
...
function Tracks(props) {
  ...
  var _React$useContext = React10.useContext(context_default), included = _React$useContext.included, range = _React$useContext.range, min = _React$useContext.min;
  var trackList = React10.useMemo(function() {
    if (!range) {
      if (values.length === 0) {
        return [];
      }
  ...
  return included ? trackList.map(function(_ref, index) {
    ...
    return React10.createElement(Track, {
      index,
      prefixCls,
      style: getIndex(style, index),
      start,
...
function Mark(props) {
  ...
  var _React$useContext = React11.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, direction = _React$useContext.direction, includedStart = _React$useContext.includedStart, includedEnd = _React$useContext.includedEnd, included = _React$useContext.included;
...
function Marks(props) {
  ...
  return React12.createElement("div", {
    ...
    return React12.createElement(Mark, {
      key: value,
...
function Dot(props) {
  ...
  var _React$useContext = React13.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, direction = _React$useContext.direction, included = _React$useContext.included, includedStart = _React$useContext.includedStart, includedEnd = _React$useContext.includedEnd;
...
function Steps(props) {
  ...
  var _React$useContext = React14.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, step = _React$useContext.step;
  var stepDots = React14.useMemo(function() {
  ...
  return React14.createElement("div", {
    ...
    return React14.createElement(Dot, {
      prefixCls,
      key: dotValue,
      value: dotValue,
      style,
...
var Slider = React16.forwardRef(function(props, ref) {
  ...
  var handlesRef = React16.useRef();
  var containerRef = React16.useRef();
  ...
  return React16.createElement(context_default.Provider, {
    ...
    style: railStyle
  }), React16.createElement(Tracks, {
    prefixCls,
    style: trackStyle,
    values: sortedCacheValues,
    startPoint,
    onStartMove: mergedDraggableTrack ? onStartMove : null
  }), React16.createElement(Steps, {
    prefixCls,
    marks: markList,
    dots,
    style: dotStyle,
