...
export declare function getTrendingFacets<TObject>({ recommendClient, transformItems, fallbackParameters, indexName, maxRecommendations, queryParameters, threshold, facetName, }: GetTrendingFacetsProps<TObject>): Promise<{
