...
export type ButtonUnstyledProps<D extends React.ElementType = ButtonUnstyledTypeMap['defaultComponent']> = OverrideProps<ButtonUnstyledTypeMap<{}, D>, D> & {
    component?: D;
};
...
export type ButtonUnstyledRootSlotProps = Simplify<UseButtonRootSlotProps & {
