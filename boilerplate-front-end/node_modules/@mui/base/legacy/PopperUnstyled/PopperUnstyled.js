...
var PopperTooltip = /*#__PURE__*/React.forwardRef(function PopperTooltip(props, ref) {
  ...
  var _React$useState2 = React.useState(anchorEl),
    tooltipAnchorEl = _React$useState2[0],
    setTooltipAnchorEl = _React$useState2[1];
  ...
  useEnhancedEffect(function () {
    ...
    var resolvedAnchorEl = resolveAnchorEl(tooltipAnchorEl);
    ...
    var popper = createPopper(resolveAnchorEl(tooltipAnchorEl), tooltipRef.current, _extends({
