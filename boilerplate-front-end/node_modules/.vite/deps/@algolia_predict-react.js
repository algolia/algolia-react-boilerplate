...
function computeCartAbandonment(funnelStage) {
  var addToCartPrediction = funnelStage.find(
    function(x) {
  ...
  if (addToCartPrediction.probability >= Math.max.apply(null, funnelStage.map(function(stage) {
...
// node_modules/@algolia/predict-core/dist/esm/lib/logDebug.js
...
function runAction(message, _ref) {
  var init = _ref.init, highlighter = _ref.highlighter, personifier = _ref.personifier;
...
// node_modules/@algolia/predict-core/dist/esm/lib/storage.js
...
function createStorage(_ref) {
  var key = _ref.key, storage = _ref.storage;
...
// node_modules/@algolia/predict-core/dist/esm/tools/personifier.js
function createPersonifier(_ref) {
  var onPersonificationStart = _ref.onPersonificationStart, onPersonificationEnd = _ref.onPersonificationEnd;
...
function initPredictTools(_ref) {
  var version3 = _ref.version, getContext = _ref.getContext, subscribe = _ref.subscribe, startPersonification = _ref.startPersonification, endPersonification = _ref.endPersonification;
...
function predict(params) {
  ...
  var pendingUpdates = [];
  var applyUpdate = function applyUpdate2(nextParams) {
