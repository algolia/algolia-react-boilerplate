  ...
  "node_modules/@algolia/recommend/dist/recommend.umd.js"(exports, module) {
    !function(e, t) {
      ...
      function R(e2, t2, n2) {
        ...
        } }), responsesCache: i(), requestsCache: i({ serializable: false }), hostsCache: u({ caches: [a({ key: "".concat("4.14.2", "-").concat(e2) }), i()] }), userAgent: j("4.14.2").add({ segment: "Recommend", version: "4.14.2" }).add({ segment: "Browser" }), authMode: c.WithinQueryParameters };
